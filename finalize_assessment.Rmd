...
One you have completed filling in citation information, right click the item in Zotero and choose "Export Item...". Export as a BibLaTeX file and save as a .bib to your computer. It is important that when you right click the item and export it, you are working from the "OHI Global Refs" folder. 
...
Make sure all references are included in the OHI Zotero library (see Section 5.3: Citation Management for more). Then export the folder "OHI Global Refs" as a BibLaTeX file and replace the OHI.bib file in ohi-global/global_supplement with the updated file.
